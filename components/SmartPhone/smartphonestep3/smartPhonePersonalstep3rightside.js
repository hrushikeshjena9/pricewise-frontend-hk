...
const SmartPhonePersonalstep3rightside = () => {
  return (
    <div className="stepright3">
      ...
      <div className="mt-4">
        <p><strong>Tip:</strong> Mocht je toch jouw deal willen wijzigen, geen probleem daar heb je 14 dagen de tijd voor.</p>
      </div>
...
export default SmartPhonePersonalstep3rightside;