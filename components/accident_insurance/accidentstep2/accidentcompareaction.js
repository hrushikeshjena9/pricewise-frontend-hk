...
function AccidentCompareAction() {
        ...
        <div className="login-deals-box">
          <div className="spe-action">
            <div className="spe-cont">
              <Image width={35} height={35} src="/images/stopwatch.png" alt="asd"/>
              <h5>Actie:</h5>
              <p>Geldig tot dd-mm-jj</p>
            </div>
            <div className="spe-cont">
              <Image width={35} height={35} src="/images/sale.png" alt="asd"/>
              <p>Energise korting:</p>
              <h4>€...</h4>
              <i className="fas fa-info" />
            </div>
            <div className="spe-cont">
              <Image width={35} height={35} src="/images/hot-sale.png" alt="asd"/>
              <p>Totaal korting:</p>
              <h4>€...</h4>
            </div>
          </div>
            ...
            <div className="row">
              <div className="col-xl-3 col-lg-4 col-md-3">
                <div className="spe-img">
                  <Image width={189} height={133} src="/images/sunbg.png" alt="asd"/>
                </div>
              </div>
                    ...
                    <div className="tabbxleft">
                      ...
                      <h4>Ongevallenverzekering</h4>
                        ...
                        <table className="table table-striped table-bordered">
                          <tbody>
                            <tr>
                              <th scope="row" className="cl-orange">Totaal</th>
                              <td className="cl-orange">€... p.m.</td>
                            </tr>
                            <tr>
                ...
                <div className="tabinsidebx table-responsive">
                  <table className="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Binnen/buitenshuis</td>
                        <td>
                          <Image width={36} height={36}
                            src="/images/faqicon.png"
                            className="img-fluid okicon" alt="aa"
                          />
                        </td>
                        <td>
                          <select className="form-select">
                      ...
                      <div className="modal-body">
                        ...
                        <div className="selectquantity">
                          <div className="cov-over-title">
                            ...
                            <Image width={128} height={128} src="/images/shield.png" alt="asd"/>
                          </div>
...
export default AccidentCompareAction;
