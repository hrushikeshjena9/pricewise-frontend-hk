...
import AccidentCompareLeftSide from './accidentcompareleftside'
import AccidentCompareAction from './accidentcompareaction';
import AccidentCompareModuleIndex from '../accidentstep3/accidentcomparemoduleindex';
import ComparisonCofirmMail from '../../Glass/GlassStep4/comparison-cofirm-mail';
import Image from 'next/image';

function AccidentComparison() {
            ...
            <section>
                ...
                <div className="comparestep">
                    ...
                    <div className="col-lg-4">
                        <AccidentCompareLeftSide />
                    </div>

                    <div className="col-lg-8">
                        <AccidentCompareAction />
                    </div>
                    </div>
                </div>
                </div>
