...
import FarmhouseComparisonleftbar from './FarmHouseComparisonleftbar';
import FarmhouseCompareaction from './FarmHouseCompareaction';
...
function FarmhouseComparisonindex() {
          ...
          <div className="comparestep">
            ...
            <div className="row">
              <div className="col-lg-4">
                <FarmhouseComparisonleftbar />
              </div>

              <div className="col-lg-8">
                <FarmhouseCompareaction />
              </div>
            </div>
          </div>
        </div>
...
export default FarmhouseComparisonindex;