...
function FarmhousecomparisoncofirmMail() {
  return (
    <section>
          ...
          <div className="row">
            ...
            <div className="col-lg-4">
              <div className="stepright3">
                ...
                <div className="mt-4">
                    <p><strong>Tip:</strong> Wist jij dat als jouw bedrijf een Energise account heeft. Jij inzicht krijgt in al jouw producten & diensten die jij bij ons afneemt.</p>
                </div>
                <div className="card mt-4">
                  <div className="card-body p-0 shadow">
                    <div className="enter-prise-acc">
...
export default FarmhousecomparisoncofirmMail;