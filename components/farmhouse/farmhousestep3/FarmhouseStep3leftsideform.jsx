...
function FarmhouseStep3leftsideform() {
  return (
    <>
          ...
          <form>
            ...
            <div className="row">
              <div className="col-lg-6  align-items-center">
                <label className="col-12 col-form-label mb-0 me-3">
        ...
        <div className="card-body">
          ...
          <div className="add-ques-bx">
            <div className="row">
              <div className="col-lg-6">
                <div className="ad-ques-text">
                  <p>Ben jij van plan jouw woning ingrijpend te verbouwen?*</p>
                  <i className="fa fa-info-circle" />
                </div>
              </div>
              <div className="col-lg-6">
...
export default FarmhouseStep3leftsideform;
