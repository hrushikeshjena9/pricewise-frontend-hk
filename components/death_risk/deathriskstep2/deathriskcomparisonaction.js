...
function DeathRiskComparisonAction() {
            ...
            <div className="tab-content" id="myTabsContent">
                ...
                <div className="row">
                    ...
                    <div className="tabbxleft">
                        ...
                        <table className="table table-striped table-bordered">
                            <tbody>
                            <tr>
                                <th scope="row">Verzekeringsvorm:</th>
                                <td>Annuïtair dalend</td>
                            </tr>
                            <tr>
                ...
                <div className="tabinsidebx table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                        <td>Verpanding polis</td>
                        <td>.....</td>
                        <td>.....</td>
                        </tr>
                        <tr>
                        <td>Medische acceptatie</td>
                        <td>.....</td>
                        <td>.....</td>
                        </tr>
                        <tr>
...
export default DeathRiskComparisonAction