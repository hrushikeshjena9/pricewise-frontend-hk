...
const CyberTwoOnderwerp = () => {
    return (
        <>
            <section>
                <div className="faq-wrp dealquestion">
                    <div className="page-title">
                        <h2><span>Alles over onze</span> Cybersecurity Deals</h2>
                    </div>
                    <div className="topicdeal">
                        <div className="container">
                            <div className="card">
                                ...
                                <select className="form-select selectfaqtopic" id="asd">
...
export default CyberTwoOnderwerp