                ...
                <div className="tab-content" id="myTabsContent">
                                    ...
                                    <div className="table-responsive">
                                        <table className="table table-striped table-bordered">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th scope="row">Totaal kosten:
                                                    </th><td />
                                                </tr>
                                                <tr>
                                                    <th scope="row">Energise bespaart:
                                                    </th><td />
                                                </tr>
                                                <tr>
                                                    <td colSpan={2}>
                        ...
                        <div className="tabinsidebx table-responsive">
                            <table className="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Privacy protector</td>
                                        <td>....</td>
                                        <td />
                                    </tr>
                                    <tr>
                                        <td>Kindvriendelijk gebruik</td>
                                        <td>....</td>
                                        <td />
                                    </tr>
                                    <tr>
                                        <td>Veilig internetten</td>
                                        <td>....</td>
                                        <td />
                                    </tr>
                                    <tr>
                    ...
                    <div className="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                        <div className="tabinsidebx">
                            <table className="table table-bordered">
                                <tbody><tr>
                                    <td><i className="fas fa-file-alt" /></td>
                                    <th colSpan={2}>Cybersecurity checklist</th>
                                </tr>
                                    <tr>
                                        <td><i className="fas fa-university" /></td>
                                        <td>Bankier veilig</td>
                                        <td align="center"><Image width={36} height={36} alt="aa" src="assets/images/faqicon.png" className="img-fluid okicon" /></td>
                                    </tr>
                                    <tr>
                                        <td><i className="fas fa-theater-masks" /></td>
                                        <td>Anti diefstal</td>
                                        <td align="center"><Image width={36} height={36} alt="aa" src="assets/images/faqicon.png" className="img-fluid okicon" /></td>
                                    </tr>
                                    <tr>
                                        <td><i className="fas fa-user-secret" /></td>
                                        <td>Privacy protector</td>
                                        <td align="center"><Image width={36} height={36} alt="aa" src="assets/images/faqicon.png" className="img-fluid okicon" /></td>
                                    </tr>
                                    <tr>
                                        <td><i className="fas fa-child" /></td>
                                        <td>Kindvriendelijk </td>
                                        <td align="center"><Image width={36} height={36} alt="aa" src="assets/images/faqicon.png" className="img-fluid okicon" /></td>
                                    </tr>
                                    <tr>
                                        <td><i className="fas fa-ethernet" /></td>
                                        <td>Veilig internetten</td>
                                        <td align="center"><Image width={36} height={36} alt="aa" src="assets/images/faqicon.png" className="img-fluid okicon" /></td>
                                    </tr>
                                    <tr>
                                        <td><i className="fas fa-bug" /></td>
                                        <td>Anti virus</td>
                                        <td align="center"><Image width={36} height={36} alt="aa" src="assets/images/faqicon.png" className="img-fluid okicon" /></td>
                                    </tr>
                                </tbody></table>
                            ...
                            <div className="col-lg-6">
                                <div className="tabbxright">
                                    ...
                                    <div className="accordion" id="stepAccordion">
                                        ...
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" id="stap7"><button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#stapc7" aria-expanded="false" aria-controls="stapc7"> Stap 7 </button></h2>
                                            <div id="stapc7" className="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#stepAccordion">
                                                <div className="accordion-body"> Antwoord op vraag 7. </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="text-center"> <a href="javascript:void(0);" className="viwmr">Meer vragen?</a> </div>
                            </div>
                        </div>
                    </div>
                    <div className='row'>
