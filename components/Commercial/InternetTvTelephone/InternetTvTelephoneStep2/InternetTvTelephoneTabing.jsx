...
const InternetTvTelephoneTabing = () => {
  return (
     <>
                                ...
                                <div className="tabbxleft">
                                    ...
                                    <h4>Zakelijk Internet kosten</h4>
                                        <table className="table table-striped table-bordered">
                                            <tbody>
                                                <tr>
                                                    <th colSpan={2}>Pakket:...</th>
                                                </tr>
                                                <tr>
                                                    <th>Kosten:<a href='javascript:void(0);' className='text-dark'><i class="fas fa-info"></i></a></th>
                                                    <td>€</td>
                                                </tr>
                                                <tr>
                                                    <th>Eenmalige kosten:<a href='javascript:void(0);' className='text-dark'><i class="fas fa-info"></i></a></th>
                                                    <td>€</td>
                                                </tr>
                                                <tr>
                                                 <th>Overige kosten:<a href='javascript:void(0);' className='text-dark'><i class="fas fa-info"></i></a></th>
                                                 <td></td>
                                                </tr>
                                                <tr>
                    ...
                    <div className="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
                        <div className="row">
                            ...
                            <div className="col-lg-6">
                                ...
                                <div className="text-center">
                                    <a href="javascript:void(0);" className="viwmr">Heb je nog vragen?</a>
                                </div>
                            </div>
                      </div>
                  </div>
...
export default InternetTvTelephoneTabing