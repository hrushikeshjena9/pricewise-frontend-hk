...
const InternetTvTelephoneStep4left = () => {
    return (
        <>
            <div className="col-lg-8">
                <div className="lsttitle">
                    ...
                    <div className="secure-wrp">
                        <Image src="/images/secure.png" width={200} height={200} alt='aa' className="img-fluid secureimg" />
                    </div>
                    <h4>
...
export default InternetTvTelephoneStep4left