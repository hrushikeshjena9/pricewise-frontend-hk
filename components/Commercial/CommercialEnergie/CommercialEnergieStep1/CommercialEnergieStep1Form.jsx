...
const CommercialEnergieStep1Form = ({
  setShowStepper,
  showStepper,
  setCount,
}) => {
                        ...
                        <div className="row">
                          <div className="col-12 px-4 radiobx">
                            <div className="row">
                              ...
                              <div className="col-lg-3  col-6  col-sm-6  p-0  col-md-3">
                                <input type="radio" name="test" id="cb24" className="tooltip-container" />
                                <label htmlFor="cb24" className="tooltip-container">
                                  <Image
                    ...
                    <div className="col-lg-6 eventbxright">
                      <div className="row">
                        <div className="col-9">
                          ...
                          <div className="row mt-3">
                            {meter == 0 ? <div className="col-12">
                              <div className="row">
                                <div className="col-lg-6">
                                  <label className="fw-medium form-control">Verbruik Normaal</label>
                                </div>
                                <div className="col-lg-6 position-relative">
                                  <div className="form-group ">
                                    <input
                                      type="text"
                                      placeholder="1000 kWh/p.j."
                                      className="form-control"
                                    />
                                    <div className="infcalcubx info-pos">
                                      <a
                                ...
                                <div className="col-lg-6">
                                <label className="fw-medium form-control">Verbruik Dal</label>
                                </div>
                                <div className="col-lg-6 position-relative">
                                  <input
                                    type="text"
                              ...
                              <div className="col-12">
                                <div className="row">
                                  <div className="col-lg-6">
                                    <label className="fw-medium form-control">Stroomverbruik</label>
                                  </div>
                                  <div className="col-lg-6 position-relative">
                                    <div className="form-group ">
                                      <input
                                        type="text"
                                        placeholder="2000 kWh/p.j."
                                        className="form-control"
                                      />
                                      <div className="infcalcubx info-pos">
                                        <a
                            ...
                            <label className="fw-medium form-control">Energielabel</label>
                              <div className="infcalcubx info-pos">
                                <a
                                  href="javascript:void(0);"
                                  data-bs-toggle="tooltip"
                              ...
                              <div className="row mt-2">
                                ...
                                <div className="col-lg-6 position-relative">
                                  <input
                                    ...
                                    className="form-control"
                                  />
                                  <div className="infcalcubx only-info-absolute-energiright-commercial">
                                    <a
                                      href="javascript:void(0);"
                                      data-bs-toggle="tooltip"
                                      data-bs-html="true"
                          ...
                          <div className="row mt-4">
                            <div className="col-lg-12">
                              <div className="rangebtn">
                                ...
                                <a href="javascript:void(0);" onClick={() => setShowExtendedForm(0)}>
...
export default CommercialEnergieStep1Form;
