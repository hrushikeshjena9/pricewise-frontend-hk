...
const CommercialEnergieStep4Right = () => {
                    ...
                    <div className="card mt-4">
                        <div className="card-body p-0 shadow">
                            <div className="enter-prise-acc">
                                ...
                                <p>
                                <b>Tip:</b>
                                 Wist jij dat als jouw bedrijf een Energise account heeft. Jij inzicht krijgt in al jouw producten & diensten die jij bij ons afneemt.
                            </p>
                            </div>
                    ...
                    <div className="card mt-4">
                        <div className="card-body p-0 shadow">
                            <div className="enter-prise-acc">
                                ...
                                <p>
                                 <b>Tip: </b> Mits jij niet verhuist, zeggen wij jouw provider of leverancier op en kan jij beginnen met deze op maat gemaakte deal!
                                </p>
                            </div>
                        </div>
                    </div>
...
export default CommercialEnergieStep4Right