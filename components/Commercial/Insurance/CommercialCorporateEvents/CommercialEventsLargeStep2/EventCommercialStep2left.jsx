...
const EventCommercialStep2left = () => {
    return (
        <>
                    ...
                    <div className="yourdetailedit">
                        <div className="row">
                            ...
                            <div className="col-lg-6 text-end">
                                <ul>
                                    <li>
                                        <Image width={24} height={24} alt="aa" src="/images/add-location-point.png" className="img-fluid" />
                                        <span>1/1</span>
                                    </li>
                                    <li>
                                        <Image width={24} height={24} alt="aa" src="/images/calendar-4.png" className="img-fluid" />
                                        <span>1/1</span>
                                    </li>
                                    <li>
                                        <Image width={24} height={24} alt="aa" src="/images/viewpop.png" className="img-fluid" />
                                        <span>1/1</span>
                                    </li>
                                </ul>
                            </div>
                ...
                <div className='row'>
                    ...
                    <div className='row'>
                        <div className='col-12 text-center position-relative'>
                            <label className='form-label fw-medium labeltitle'>Feestgrootte</label>
                            <div className="infbx infbx2 info-in-absolute">
                    ...
                    <div className='row'>
                        <div className='col-5'>
                            <label className='form-label fw-medium'><Image src='/images/catering-3.png' alt='catering' width={35} height={35} /> Catering</label>
                        </div>
                        <div className='col-7'>
...
export default EventCommercialStep2left