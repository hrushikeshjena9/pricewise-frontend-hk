...
const GlassInsuranceCommercialStep4Right = () => {
  return (
    <>
        ...
        <div className="stepright3">
          <div className="card mt-4">
            <div className="card-body p-0 shadow">
              ...
              <p className="px-4">
                <b>Tip:</b> Wist jij dat als jouw bedrijf een Energise account heeft. Jij inzicht krijgt in al jouw producten 
...
export default GlassInsuranceCommercialStep4Right