...
const GlassInsuranceCommercialStep3Left = ({ setShow, show }) => {
                ...
                <div className="card mt-4">
                    ...
                    <div className="card-body">
                        ...
                        <div className="row mb-2">
                            <div className="col-lg-6">
                                ...
                                <ul className="list-unstyled list-style-cr">
                                    ...
                                    <li className='fw-medium'> Weigering bij een aanvraag of opzegging van de Verzekeraar</li>
                        ...
                        <div className="row">
                              ...
                              <div className="col-lg-6">
                              <label className="fw-bold">Glasverzekering</label>
                              </div>
                          </div>
                          <div className="row">
                              <div className="col-lg-6">
...
export default GlassInsuranceCommercialStep3Left;