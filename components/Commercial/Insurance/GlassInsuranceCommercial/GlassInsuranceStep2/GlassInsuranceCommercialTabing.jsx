...
const GlassInsuranceCommercialTabing = () => {
    return (
        <>
            <div id="listhiddenDiv1" className="tabwrp">
                ...
                <div className="tab-content" id="myTabsContent">
                            ...
                            <div className="col-lg-6">
                                <div className="tabbxleft">
                                    <div className="table-responsive table-scroll">
                                        <h4>Glasverzekering</h4>
                                        <table className="table table-striped table-bordered">
                                            <tbody>
                                                <tr>
                                                    <th>Premie kosten: <sup><i className="fas fa-info"></i></sup></th>
                                                    <td>€....</td>
                                                </tr>
                                                <tr>
                                                    <th>Aanvulling: <sup><i className="fas fa-info"></i></sup></th>
                                                    <td>€....</td>
                                                </tr>
                                                <tr>
                                                    <th>Eenmalige kosten: <sup><i className="fas fa-info"></i></sup></th>
                                                    <td>€....</td>
                                                </tr>
                                                <tr>
                                                 <th>Overige kosten: <sup><i className="fas fa-info"></i></sup></th>
                                                 <td>€....</td>
                                                </tr>
                                                <tr>
                    ...
                    <div className="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                        <div className="tabinsidebx table-responsive">
                            <table className="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <select className='form-select'>
                                                <option>Data Show Here 1</option>
                                                <option>Data Show Here 2</option>
                                                <option>Data Show Here 3</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Speciaal glas</td>
                                        <td><Image src='/images/faqicon.png' width={24} height={24} alt='aa'/></td>
                                        <td>
                                            <select className='form-select'>
                                                <option>Data Show Here 1</option>
                                                <option>Data Show Here 2</option>
                                    ...
                                    <tr>
                                        <td>Belettering opnieuw Aanbrengen</td>
                                        <td><Image src='/images/faqicon.png' width={24} height={24} alt='aa'/></td>
                                        <td>
                                            <select className='form-select'>
                                                <option>Data Show Here 1</option>
                        ...
                        <div>
                        <a className="btn" data-bs-toggle="modal" href="#BekijkModalToggle" role="button">Bekijk meer</a>
                        <div className="modal fade" id="BekijkModalToggle" aria-hidden="true" aria-labelledby="BekijkModalToggleLabel2" tabIndex={-1}>
                           ...
                           <button type="button" className="btn-close close-modal" data-bs-dismiss="modal" aria-label="Close"><i className="fas fa-times" /></button>
                                <div className="modal-body">
                                    ...
                                    <div className='text-center'>
                                    <a href='javscript:void(0);' className='text-dark'>Dekkingskaart</a>
                                    </div>
                                </div>
                            </div>
                            </div>
                    ...
                    <div className="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
                        <div className="row">
                            ...
                            <div className="col-lg-6">
                                ...
                                <div className="text-center"> 
                                <a href="javascript:void(0);" className="viwmr">Heb je nog vragen?</a> </div>
                            </div>
                        </div>
                    </div>
                    <div className="row">
...
export default GlassInsuranceCommercialTabing