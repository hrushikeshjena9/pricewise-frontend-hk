...
const GlassInsuranceCommercialDealsAll = ({ setShowMoreInfo, showMoreInfo }) => {
            ...
            <div className="login-deals-box">
                ...
                <div className="spe-action-data">
                    ...
                    <div className="form-check d-flex justify-content-center mb-3">
                        <input className="form-check-input me-2" type="checkbox" id="acceptConditions" name="acceptConditions"
                            checked={open}
...
export default GlassInsuranceCommercialDealsAll
