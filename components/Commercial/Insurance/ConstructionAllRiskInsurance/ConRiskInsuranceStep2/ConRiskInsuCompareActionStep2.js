...
import ConRiskInsuCompareTabbingPartStep2 from './ConRiskInsuCompareTabbingPartStep2';

const ConRiskInsuCompareActionStep2 = () => {
  ...
  return (
    <>
      <div className="listofcompanybx">
        ...
        {showMoreInfo && 
        <ConRiskInsuCompareTabbingPartStep2 />
        }
      </div>
    </>
  );
...
export default ConRiskInsuCompareActionStep2;
