              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="row">
                    <div className="col-lg-6 position-relative">
                      ...
                      <a className="aanvullende-text-info" href="#">
                ...
                <div className="col-lg-12">
                  <div className="row">
                    <div className="col-lg-6">
                      <label htmlFor="abroadIncome" className="col-form-label">
                      Is het gebouw beveiligd door een alarminstallatie en/of voorzien van camaratoezicht?
                      </label>
                    </div>
                    <div className="col-lg-6">
                      <div className="row">
                ...
                <div className="col-lg-12">
                  <div className="row">
                    <div className="col-lg-6">
                      ...
                      <p className='small'>
                        Betonrenovatie betonbouw kelderbouw (paal) funderingswerk grondkerende constructies (zoals damwanden) (bron) bemaling 
                        ondergrondse kabels&#x2c; Vloerafwerking&#x2c; sloopprojecten&#x2c; asbestsanering&#x2c; grond-weg en waterbouw.
                        </p>
                    </div>
                    <div className="col-lg-6">
                      <div className="row">
            ...
            <div className="card-body">
              ...
              <div className="mb-3">
                <div className="form-check">
                  ...
                  >
                    Ik accepteer alle <a className='ac-con-bx' href='javascript:void(0);'>voorwaarden</a>.
                  </label>
                </div>
              </div>
              <div className="mb-3">
...
export default ConRiskInsuLeftStep3;
