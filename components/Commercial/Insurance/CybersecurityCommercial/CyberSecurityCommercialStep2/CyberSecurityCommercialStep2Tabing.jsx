...
const CyberSecurityCommercialStep2Tabing = () => {
    return (
        <>
                            ...
                            <table className="table table-bordered">
                                <tbody><tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><Image width={36} height={36} alt="aa" src="/images/faqicon.png" className="img-fluid okicon" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select className='form-select'>
                                                <option value="1">Data Show Here 1</option>
                                                <option value="1">Data Show Here 2</option>
                                                <option value="1">Data Show Here 3</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
...
export default CyberSecurityCommercialStep2Tabing
