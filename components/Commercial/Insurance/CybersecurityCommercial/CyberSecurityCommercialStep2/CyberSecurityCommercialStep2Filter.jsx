...
const CyberSecurityCommercialStep2Filter = () => {
    return (
            ...
            <div className="loan-left">
                <div className='row'>
                    <div className='col-lg-10'>
                        <label className='form-label fw-medium text-warning bg-dark px-4 py-2'><i class="fas fa-cog me-2"></i>Aanvullende dekking</label>
                    </div>
                </div>
                <div className='row'>
                <div className='col-lg-10'>
                ...
                <div className='row'>
                    <div className='col-9  mt-3'>
                        <label className='form-label fw-medium text-warning bg-dark px-4 py-2'><i class="fas fa-cog me-2"></i>Ondersteuning</label>
                    </div>
                </div>
                <div className='row'>
                    <div className='col-9'>
...
export default CyberSecurityCommercialStep2Filter