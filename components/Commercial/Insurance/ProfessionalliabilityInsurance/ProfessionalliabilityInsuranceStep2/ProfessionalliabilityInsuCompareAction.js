...
import ProfessionalliabilityInsuCompareTabbingPart from './ProfessionalliabilityInsuCompareTabbingPart'

const ProfessionalliabilityInsuCompareAction = () => {
  ...
  return (
    ...
    <div className="listofcompanybx">
      ...
      {showMoreInfo && (
        <ProfessionalliabilityInsuCompareTabbingPart />
      )}
    </div>
  </>
  )
...
export default ProfessionalliabilityInsuCompareAction
