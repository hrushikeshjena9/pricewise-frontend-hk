...
const ProfessionalliabilityInsuranceCounselCompareStep4 = () => {
  return (
    <>
      <section>
            ...
            <div className="row">
                ...
                <div className="col-lg-12 lstleftbox">
                  <div className="card">
                    <div className="card-body">
                      <h4>Veel plezier!</h4>
                      <p>
                        Bedankt voor jouw bestelling <b>(naam)</b>. Jij kan er
                        voorlopig weer tegen aan!
                        <br />
                        <br />
                        Wij hebben jouw gegevens verwerkt met een unieke
                        bestellingsnummer (............). Jouw op maat gemaakte
                        deal is verzonden naar <b>(email)</b>. Het kan soms
                        voorkomen, dat jouw deal toch nog in de spam terecht is
                        gekomen.
                        <br />
                        <br />
                        Mocht jij nog vragen hebben? Neem gerust{" "}
                        <a href="#">contact</a> met ons op of bekijk de{" "}
                        <a href="#">veel gestelde vragen.</a> Wij wensen jou
                        namens onze team heel veel plezier.
                        <br />
                        <br />
                        Tip: Wist je dat Energise Company{" "}
                        <a href="#">vergelijk meer</a> korting geeft? Maak snel
                        een <a href="#">account</a> aan en ontvang stapelgekken
                        korting!
                      </p>
                    </div>
                  </div>
              ...
              <div className="col-lg-4">
                <div className="stepright3">
                          ...
                          <div className="accordion-item">
                            ...
                            >
                              <div className="accordion-body">
                                ...
                                adipisicing elit. Fugit voluptatibus natus quod
                                ab necessitatibus. Accusantium, ut alias.
                              </div>
                            </div>
                          </div>
                          <div className="accordion-item">
                            ...
                            >
                              <div className="accordion-body">
                                Lorem ipsum dolor sit amet consectetur
                                adipisicing elit. Impedit laborum commodi
                                placeat modi beatae eveniet iste quisquam eius
                                ratione.
                              </div>
                            </div>
                          </div>
                  ...
                  <div className="mt-4">
                    <p>
                      <strong>Tip:</strong> Wist jij dat als jouw bedrijf een
                      Energise account heeft. Jij inzicht krijgt in al jouw
                      producten & diensten die jij bij ons afneemt.
                    </p>
                  </div>
                  <div className="card mt-4">
                    <div className="card-body p-0 shadow">
...
export default ProfessionalliabilityInsuranceCounselCompareStep4
