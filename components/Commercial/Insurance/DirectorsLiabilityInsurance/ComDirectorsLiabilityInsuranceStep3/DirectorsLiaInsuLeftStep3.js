...
const DirectorsLiaInsuLeftStep3 = () => {
  return (
    <>
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className='row'>
                      ...
                      Is de organisatie&#xb4; een van de bestuurders of toezichthouders op de hoogte van gerechtelijke stappen&#xb4; fouten of 
                      omstandigheden die kunnen leiden tot een aanspraak onder een bestuurdersaansprakelijkheid verzekering?*
                        </label>
                ...
                <div className="col-lg-12 mt-3">
                  <div className="row">
                    <div className="col-lg-6">
                      <label htmlFor="abroadIncome" className="col-form-label">
                      Is de organisatie&#xb4; een van de bestuurders of toezichthouders betrokken 
                      in een proces of verwachten zij op korte termijn daarin betrokken te raken?*
                      </label>
                    </div>
                    <div className="col-lg-6">
                      <div className="row">
                      ...
                      <textarea className='form-control mt-2' placeholder='Oorzaak' rows={5}></textarea>
                    </div>
                  </div>
                </div>
                <div className="col-lg-12 mt-2">
                  <div className="row ">
                    ...
                    <div className="col-lg-6">
                      ...
                      <h5 className='mb-0 mt-3'>Jaarrekeningen*</h5>
                      <p className='mb-0 small text-danger'>Let op&#xb4; dit geld alleen voor een volledige boekjaar.</p>
                      <div className="row">
...
export default DirectorsLiaInsuLeftStep3
