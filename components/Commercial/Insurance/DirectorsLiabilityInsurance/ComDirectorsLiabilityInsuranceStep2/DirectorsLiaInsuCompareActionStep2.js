...
import DirectorsLiaInsuCompareTabbingPartStep2 from './DirectorsLiaInsuCompareTabbingPartStep2'

const DirectorsLiaInsuCompareActionStep2 = () => {
  ...
  return (
    ...
    <div className="listofcompanybx">
      ...
      {showMoreInfo && (
        <DirectorsLiaInsuCompareTabbingPartStep2 />
      )}
    </div>
  </>
  )
...
export default DirectorsLiaInsuCompareActionStep2
