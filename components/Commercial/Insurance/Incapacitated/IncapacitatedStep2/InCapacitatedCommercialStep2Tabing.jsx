...
const InCapacitatedCommercialStep2Tabing = () => {
    return (
        <>
                ...
                <div className="tab-content" id="myTabsContent">
                            ...
                            <div className="col-lg-7">
                                <div className="tabbxleft">
                                    ...
                                    <div className="table-responsive table-scroll">
                                        <h4>Arbeidsongeschikheidverzekering</h4>
                    ...
                    <div className="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                        <div className="tabinsidebx table-responsive">
                            ...
                            <div>
                                <a className="btn btn-link text-dark" data-bs-toggle="modal" href="#BekijkModalToggle" role="button">Bekijk meer</a>
...
export default InCapacitatedCommercialStep2Tabing