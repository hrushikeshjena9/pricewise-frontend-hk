...
const InCapacitatedCommercialStep2left = () => {
    return (
        <div className="col-lg-4">
            <div className="yourdetailsbox">
                ...
                <ul className="infodetails">
                    ...
                    <li>
                        Uitkeringsduur: <span>Tijdelijk</span>
            ...
            <div className="loan-left">
                ...
                <div className="row mt-2">
                    <div className="col-6">
                        <label className="form-label labeltitle">Zonder uitkering</label>
                    </div>
                    <div className="col-4">
                        <input type="number" className="form-control" id="numberInput1" min={1} defaultValue={1} />
                    </div>
                ...
                <div className="row mt-2">
                    <div className="col-6">
                        <label className="form-label labeltitle">Uitkeringsduur</label>
                    </div>
                    <div className="col-4">
                        <input type="number" className="form-control" id="numberInput1" min={1} defaultValue={1} />
                    </div>
                ...
                <div className="row mt-2">
                    <div className="col-6">
                        <label className="form-label labeltitle">Eindleeftijd</label>
                    </div>
                    <div className="col-4">
                        <input type="number" className="form-control" id="numberInput1" min={1} defaultValue={1} />
                    </div>
            ...
            <div className='support'>
                <div className='row'>
                    <div className='col-10'>
                        <label className='form-control'>Soort AOV</label>
                    </div>
                    <div className='col-2'>
                    <div className="infbx infcalcubx infbx2">
                            <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Content Goes Here" data-bs-original-title="Content Goes Here">
            ...
            <div className='loan-left'>
                <div className="form-check">
                    <input className="form-check-input me-2" type="checkbox" id="flex"/>
                    <label className="form-check-label" htmlFor="flex">Compleet: (..)</label>
                </div>
                <div className="form-check">
                    <input className="form-check-input me-2" type="checkbox" id="flex"/>
                    <label className="form-check-label" htmlFor="flex">Beperkt: (..)</label>
                </div>
                <div className="form-check">
                    <input className="form-check-input me-2" type="checkbox" id="flex"/>
                    <label className="form-check-label" htmlFor="flex">Collectief: (..)</label>
                </div>
            </div>
            ...
            <div className="support">
                ...
                <div className="form-check">
                    <input className="form-check-input me-2" type="checkbox" id="flex"/>
                    <label className="form-check-label" htmlFor="flex">Hulp bij re-intergratie: (..)</label>
                </div>
                <div className="form-check">
                    <input className="form-check-input me-2" type="checkbox" id="flex"/>
                    <label className="form-check-label" htmlFor="flex">Preventie pakket: (..)</label>
                </div>
                <div className="form-check">
                    <input className="form-check-input me-2" type="checkbox" id="flex"/>
                    <label className="form-check-label" htmlFor="flex">Financieel inzicht: (..)</label>
                </div>
            </div>
            <div className="protectionbx">
...
export default InCapacitatedCommercialStep2left