...
const VehicleInsuranceCommercialStep2Left = () => {
                        ...
                        <div className='col-8'>
                            <div className="row">
                                <div className="col-12 mb-2 position-relative">
                                    ...
                                    <div className="infcalcubx info-in-absolute info-in-sm-responsive">
                          ...
                          <div className="row d-none">
                                    ...
                                    <div className="row px-2">
                                        ...
                                        <div className="col-lg-4 p-lg-1 col-md-4">
                                            ...
                                            <label htmlFor="cb552">
                                                ...
                                                <span className="checkbox-label equal-height">ALL RISK</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-12 position-relative">
                                    ...
                                    <div className="infcalcubx hulpNinfo-in-position hulpNinfo-for-sm">
...
export default VehicleInsuranceCommercialStep2Left;