...
const VehicleInsuranceCommercialStep2Right = ({ setShowMoreInfo, showMoreInfo }) => {
          ...
          <div className="compare-item col-lg-3" id="compare-item1" style={{ display: 'block' }}>
            <div className="row">
              <div className="col-12">
                {/* <Image width={} height={} src="/images/gaenergy.png" className="img-fluid" /> */}
                <p>Company Name</p>
                <Rating
                  initialValue={3.5}
                  size={20}
...
export default VehicleInsuranceCommercialStep2Right