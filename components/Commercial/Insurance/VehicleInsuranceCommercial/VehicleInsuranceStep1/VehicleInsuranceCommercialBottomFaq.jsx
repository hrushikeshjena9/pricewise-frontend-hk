...
const VehicleInsuranceCommercialBottomFaq = () => {
  return (
    <>
      <section>
        <div className="faq-wrp dealquestion">
          <div className="page-title">
            <h2>
              Alles over <span>Aanhangwagenverzekering</span> Deals
            </h2>
          </div>
          <div className="topicdeal">
            ...
            <div className="container">
              <div className="card">
                ...
                <select
                  className="form-select selectfaqtopic"
                  id="serviceSelect"
                >
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        ...
                        sagittis. In condimentum facilisis porta. Sed nec diam
...
export default VehicleInsuranceCommercialBottomFaq;