...
import LegalCounseCompareTabbingPartStep2 from './LegalCounseCompareTabbingPartStep2'

const LegalCounselCompareActionStep2 = () => {
  ...
  return (
    ...
    <div className="listofcompanybx">
      ...
      {showMoreInfo && (
        <LegalCounseCompareTabbingPartStep2 />
      )}
    </div>
  </>
  )
...
export default LegalCounselCompareActionStep2
