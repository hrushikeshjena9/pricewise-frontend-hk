...
const LCoporateliabilityStep2Left = () => {
    return (
                ...
                <div className='row'>
                    <div className='Col-12'>
                            ...
                            <div className="col-2">
                                <div className="infbx infcalcubx infbx2">
                                    ...
                                    <a href="javascript:void(0);" >
                                        <Image width={90} height={82} alt="aa" src="/images/viewpop.png" />
                                        <span>Overzicht?</span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="col px-4 radiobx">
                                <div className="row  me-1">
                                    <div className="col-4 p-0">
                                        ...
                                        <label htmlFor="cb21">
                                            <Image width={128} height={128} alt="horeca" src="/images/bav.png" className="img-fluid" />
                                    ...
                                    <div className="col-4 p-0">
                                        ...
                                        <label htmlFor="cb22">
                                            <Image width={128} height={128} alt="aa" src="/images/carbail.png" className="img-fluid" />
                        ...
                        <div className="row mt-2">
                            ...
                            <div className="col-8 col-sm-2 position-relative">
...
export default LCoporateliabilityStep2Left