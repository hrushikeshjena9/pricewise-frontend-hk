...
const LCoporateLiabilityStep2TabingPart = () => {
    return (
        <>
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="tabbxleft">
                                    ...
                                    <h4>Aansprakelijkheid voor bedrijven</h4>
                    ...
                    <div className="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                        <div className="tabinsidebx table-responsive">
                            <table className='table table-brodered'>
                                ...
                                <tbody>
                                    <tr>
                                        <td>Personen & spullen</td>
                                        <td>€...</td>
                                        <td>
                                            <select className='form-select'>
                                                <option>Show Your Data</option>
                                                <option>Show Your Data</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Letsel & overlijden</td>
                                        <td>€...</td>
                                        <td>
                                            <select className='form-select'>
                                                <option>Show Your Data</option>
...
export default LCoporateLiabilityStep2TabingPart