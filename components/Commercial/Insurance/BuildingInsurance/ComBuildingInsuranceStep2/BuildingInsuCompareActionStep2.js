...
import BuildingInsuCompareTabbingPartStep2 from './BuildingInsuCompareTabbingPartStep2'

const BuildingInsuCompareActionStep2 = () => {
  ...
  return (
    ...
    <div className="listofcompanybx">
      ...
      {showMoreInfo && (
        <BuildingInsuCompareTabbingPartStep2 />
      )}
    </div>
  </>
  )
...
export default BuildingInsuCompareActionStep2
