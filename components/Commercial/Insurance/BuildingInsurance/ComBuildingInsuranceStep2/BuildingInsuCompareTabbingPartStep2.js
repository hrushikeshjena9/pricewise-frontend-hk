...
const BuildingInsuCompareTabbingPartStep2 = () => {
  return (
    <>
              ...
              <div className="tabinsidebx table-responsive">
                <table className="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>Noodvoorziening & Bereddingskosten</td>
                     <td>
                     <Image
                          width={200}
                          height={200}
                ...
                <a href='javascript:void(0);' className='text-dark'>Bekijk meer</a>
              </div>
            </div>
            <div
              className="tab-pane fade"
...
export default BuildingInsuCompareTabbingPartStep2
