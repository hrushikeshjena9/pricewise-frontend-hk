                    ...
                    <div className="card-body">
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <p className='mb-0'>Heb jij of een belanghebbende ooit te maken gehad met:</p>
                                <ul className="list-unstyled hd-text">
                                    <li className='fw-medium py-0'><a href='#'>Een schademelding</a></li>
                                    <li className='fw-medium py-0'><a href='#'>Weigering bij een aanvraag of opzegging van 
                                      de Verzekeraar</a>
                                    </li>
                                    <li className='fw-medium py-0'>
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                ...
                                <p className='small fw-normal text-mute'>
                            ...
                            <div className="col-lg-6">
                              ...
                              <div className='col-6'>
                              <label className="fw-bold">Gebouwenverzekering</label>
                              </div>
                              <div className='col-6'>
                              <p className="fw-bold">Schadebedrag per gebeurtenis*</p>
                              </div>
                              <div className='col-6'>
                              <input className="form-control mb-2" type="text" placeholder='€ 0' />
                              </div>
                              <div className='col-6'>
...
export default BuildingInsuLeftStep3
