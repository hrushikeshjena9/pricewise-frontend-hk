...
import BusinessInterCompareTabbingPartStep2 from './BusinessInterCompareTabbingPartStep2'

const BusinessInterCompareActionStep2 = () => {
  ...
  return (
    ...
    <div className="listofcompanybx">
      ...
      {showMoreInfo && (
        <BusinessInterCompareTabbingPartStep2 />
      )}
    </div>
  </>
  )
...
export default BusinessInterCompareActionStep2
