...
import ApplyContactCommercial from "./ApplyContact";
import ApplyFunctionCommercial from "./ApplyFunction";
import ApplyAvailabiltyCommercial from "./ApplyAvailabilty";
const ApplyIndexCommercial = () => {
    ...
    <>
      ...
      <section className="apply-form-sec">
        <div className="container">
            <div className="row">
              {count == 0 &&
                <ApplyContactCommercial  setCount={setCount} count={count} />
              }
               {count == 1 &&
                <ApplyFunctionCommercial setCount={setCount} count={count} />
              }
              {count == 2 &&
                <ApplyAvailabiltyCommercial setCount={setCount} count={count}/>
              }
            </div>
...
export default ApplyIndexCommercial;
