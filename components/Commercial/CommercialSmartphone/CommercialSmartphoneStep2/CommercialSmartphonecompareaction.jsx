...
const CommercialSmartphonecompareaction = () => {
                  ...
                  <div className="col-lg-6">
                    <div className="tabbxleft">
                      <div className="table-responsive table-scroll">
                          <h4>Zakelijk Smartphone kosten</h4>
                        <table className="table table-striped table-bordered">
                          <tbody>
                            <tr>
                              <th scope="row" colSpan={2}>Pakket: ...</th>
                            </tr>
                            <tr>
                              <th scope="row">Kosten:<a href="#" className="text-dark"><i class="fas fa-info"></i></a></th>
                              <td>€....</td>
                            </tr>
                            <tr>
                              <th scope="row">Eenmalige kosten:<a href="#" className="text-dark"><i class="fas fa-info"></i></a></th>
                              <td>€....</td>
                            </tr>
                            <tr>
                              <th scope="row">Overige kosten:<a href="#" className="text-dark"><i class="fas fa-info"></i></a></th>
                              <td>€....</td>
                            </tr>
                            <tr>
                              <th className="text-warning">Totaal:</th>
                              <td className="text-warning fw-bold">€....p.m.</td>
                            </tr>
                            <tr>
                              <th className="text-warning">Koppelkorting:<a href="#" className="text-dark"><i class="fas fa-info"></i></a></th>
                              <td className="text-warning fw-bold">€...</td>
                            </tr>
                            <tr>
                              <th scope="row">Looptijd:</th>
                              <td className=" fw-bold">..Maanden</td>
                            </tr>
                            <tr>
...
export default CommercialSmartphonecompareaction;