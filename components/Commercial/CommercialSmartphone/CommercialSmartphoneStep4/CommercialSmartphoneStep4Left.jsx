...
const CommercialSmartphoneStep4Left = () => {
    return (
        <>
            <div className="col-lg-8 comparestep3 m-0">
                <div className="lsttitle comparestep3">
                    <h2><span>Jij weet,</span> wat jij wilt!</h2>
                    <div className="secure-wrp">
                        <Image src="/images/secure.png" width={200} height={200}  className="img-fluid secureimg" alt='aa' />
                    </div>
                    <h4>
...
export default CommercialSmartphoneStep4Left