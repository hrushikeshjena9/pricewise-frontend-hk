...
const CommercialSmartphonestep3leftside = () => {
  return (
    <>
        ...
        <div className="card-body">
          ...
          <div className="row">
            <div className="col-lg-6 align-items-center">
              ...
              <input type="text" className="form-control w-100 d-block" placeholder="Bijv 1200AA 112A"  />
            </div>
...
export default CommercialSmartphonestep3leftside;