...
const CommercialSmartphonegeneralleftside = ({
  setCount,
  showCompactContent,
            ...
            <div className="col-lg-12">
              <div className="multiple-user">
                <a href="#" data-bs-toggle="modal" data-bs-target="#smartphone">
                  ...
                  <p className="d-flex">
                    <span className="link-underline-dark text-decoration-underline">Meerdere gebruikers toevoegen.</span>
                   <sup><i class="fas font-14 fa-info-circle"></i></sup>
                </p>
                </a>
              </div>
            </div>
...
export default CommercialSmartphonegeneralleftside;
