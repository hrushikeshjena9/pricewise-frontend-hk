...
const EnergyDeals = ({ data2 }) => {
    const [energyDeals, setEnergyDeals] = useState()
    useEffect(() => {
        setEnergyDeals(data2?.data)
    }, [data2])
    return (
        <>
            <section>
                                    ...
                                    <div className="card">
                                        ...
                                        <div className="card-body table-responsive">
                                            <table className='table text-nowrap'>
                                                <tbody>
                                                    {energyDeals && energyDeals.length > 0 &&
                                                        <>
                                                            {energyDeals?.map((item, i) => (
                                                                <tr key={i}>
                                                                    <td>
                                                                    <div className='deal-num'>
                                                                    <h6>{i+1}</h6>
                                                                        <Image width={200} height={200} alt="aa" src={item?.icon} />
                                                                    </div>
                                                                    </td>
                                                                    <td>
