...
const LiabilityCompareLeftSideStep2 = () => {
  ...
  return (
    <>
      ...
      <div className="cyberbxright steprangeleft coverage-left-bar liability-private-leftbar">
        <div className="cov-sp">
          <div className="row">
            <div className="col  col-10">
              <h6 className="type-cov">Soort dekking</h6>
              <div className="infbx liability-info-stepto">
                <a
          ...
          <div className="row d-none">
            <div className="col radiobx">
              <div className="row">
                <div className="col-lg-5 col-sm-5 col-10 col-md-5">
        ...
        <div className="cov-sp mb-0">
          <div className="row">
            ...
            <div className="col-10 col">
              ...
              />
              <div className="liability-in-hulp-holder">
                <a
                  href="javascript:void(0);"
                  data-bs-toggle="tooltip"
                  data-bs-html="true"
                ...
                <a href="javascript:void(0);" className="extra ">
                  ...
                  {/* <span className="d-block fw-medium">Hulp nodig?</span> */}
                </a>
              </div>
            </div>
            <div className="col-10">
...
export default LiabilityCompareLeftSideStep2;
