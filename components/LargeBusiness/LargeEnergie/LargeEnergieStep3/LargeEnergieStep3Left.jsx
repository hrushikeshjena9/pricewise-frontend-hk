                ...
                <div className="col-lg-6">
                  ...
                  />
                   <a href="javascript:void(0);" className="text-dark fw-bold">
                    <i className="fas fa-plus text-warning"></i> Extra vestiging
                  </a>
                </div>
                <div className="col-lg-6">
                  <label className="col-auto col-form-label mb-0 me-3">
                  ...
                  <a href="javascript:void(0);" className="text-dark fw-bold">
                    <i className="fas fa-plus text-warning"></i> Extra lijn
                  </a>
                </div>
              </div>
            </form>
            ...
            <div className="cerfi-bx">
              <div className="certi-cont-bx">
                ...
                <h6>
                  ...
                  <i className="fas ms-2 fa-info-circle"></i>
                </h6>
...
export default LargeEnergieStep3Left;
