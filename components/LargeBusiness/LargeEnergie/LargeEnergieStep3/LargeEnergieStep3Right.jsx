                    ...
                    <div className="card mt-4">
                        <div className="card-body p-0 shadow">
                            <div className="enter-prise-acc">
                                ...
                                <p>
                                <b>Tip:</b>
                                 Mits jij niet verhuist, zeggen wij jouw provider of leverancier op en kan jij beginnen met deze op maat gemaakte deal!
                            </p>
                            </div>
...
export default LargeEnergieStep3Right