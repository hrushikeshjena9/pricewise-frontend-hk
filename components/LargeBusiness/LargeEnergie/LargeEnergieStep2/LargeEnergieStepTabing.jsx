              ...
              <div className="col-lg-6">
                <div className="tabbxleft">
                  <div className="table-responsive table-scroll">
                    <h4>Energie kosten Grootzakelijk</h4>
                    <table className="table table-striped table-bordered">
                      <tbody>
                        ...
                        <tr>
                          <th>Normaal leveringsprijs:</th>
                          <td>€...</td>
                        </tr>
                        <tr>
                          <th>Dal leveringsprijs::</th>
                          <td>€</td>
                        </tr>
                        <tr>
                          <th>Gas leveringsprijs:</th>
                          <td>€</td>
                        </tr>
                        <tr>
...
export default LargeEnergieStepTabing;
