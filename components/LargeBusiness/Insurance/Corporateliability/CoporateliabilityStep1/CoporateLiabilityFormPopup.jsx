...
const CoporateLiabilityFormPopup = () => {
                                ...
                                <div className="col-lg-6 eventbxleft">
                                        ...
                                        <div className="col-9">
                                                    ...
                                                    <div className="infcalcubx only-infoNextra-corporateliability">
                                                        <ul className="list-unstyled">
                                                            ...
                                                            <li>
                                                                <a
                                                                    href="javascript:void(0);"
                                                                    className="extraon-corporateliability"
                                                                >
                                            ...
                                            <div className="row">
                                                <div className="col-12 position-relative">
                                                    ...
                                                    <div className="toevoe-position text-center">
                                                        <input
                                    ...
                                    <div
                                        ...
                                        <div className="row mt-2">
                                            ...
                                            <div className="col-2">
                                                <div className="infcalcubx justify-content-lg-start">
                                                    <a
                                                        href="javascript:void(0);"
                                                        data-bs-toggle="tooltip"
                                                        data-bs-html="true"
...
export default CoporateLiabilityFormPopup