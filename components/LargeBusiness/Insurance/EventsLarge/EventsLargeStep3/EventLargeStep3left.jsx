...
const EventLargeStep3left = ({ setShow, show }) => {
            ...
            <div className="compare-toppart mt-2">
                ...
                <div className="card mt-4">
                    <div className='card-header'>
                        <h4 className="mb-0"> <Image src='/images/archives.png' width={44} height={44} alt="archives"/>
                        Bedrijfsgegevens</h4>
                    </div>
                ...
                <div className="card mt-4">
                    <div className="card-header">
                        <h4 className="mb-0"><Image src='/images/contact.png' width={44} height={44} alt="contact" className="me-2"/> 
                        Contactgegevens</h4>
                    </div>
                    <div className="card-body">
                        <form>
                ...
                <div className="card mt-4">
                    <div className="card-header">
                        <h4 className="mb-0"><Image src='/images/tracking.png' width={44} height={44} alt="archives"/> Oplevering</h4>
                    </div>
                    <div className="card-body">
                        <form>
                ...
                <div className="card mt-4">
                    <div className="card-header">
                        <h4 className="mb-0">
                            <i className="fas fa-credit-card text-warning"/> Verificatie</h4>
                    </div>
                    <div className="card-body">
                        <div className="mb-3 ">
...
export default EventLargeStep3left;
