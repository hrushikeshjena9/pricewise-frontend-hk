        ...
        <>
            <div className="col-lg-4">
                    ...
                    <div className='col-lg-10'>
                        <div className="row">
                            <div className="col-6">
                                ...
                                <Image src='/images/add-location-point.png' width={28} height={28} alt='location' /> Van:</label>
                            </div>
                            <div className="col-6">
                        ...
                        <div className="row mt-2">
                            <div className="col-6 ">
                                <label htmlFor="inputPlaats" className="col-form-label form-control">
                                <Image src='/images/add-location-point.png' width={28} height={28} alt='location' /> Naar:</label>
                            </div>
                            <div className="col">
                                <input type="text" className="form-control" id="inputPlaats" placeholder="plaats" />
                            </div>
                        ...
                        <div className='col-lg-10'>
                            <div className="row">
                                <div className="form-check">
                                    <input className="form-check-input" type="checkbox" id="d" defaultValue="true" />
                ...
                <div className="row">
                    <div className='col-lg-10 text-center'>
                            <label className='form-label form-control'>
                                <Image src='/images/future-2.png' width={28} height={28} alt='future' /> Datum
                            </label>
                    </div>
                    <div className='col-lg-2'>
                        <div className="infcalcubx">
                ...
                <div className='row my-2'>
                    <div className='col-lg-10 text-center'>
                        <lable className='form-label fw-medium form-control'><i className="fas green-cyan fa fa-calculator"></i> Budget</lable>
                    </div>
                    <div className='col-lg-2'>
                        <div className="infcalcubx">
                            <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Content Goes Here" data-bs-original-title="Content Goes Here">
                ...
                <div className='support'>
                    <div className='row mb-1'>
                        <div className='col-12'>
                            ...
                            <div className="form-check mt-3">
                                <input className="form-check-input" type="checkbox" defaultValue id="Glasvezel" />
                                <label className="form-check-label" htmlFor="Glasvezel">
                                    All inclusief: (..)
                                </label>
                            </div>
