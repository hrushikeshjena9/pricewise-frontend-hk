                ...
                <div className='support'>
                    <div className='row'>
                        <div className='col-lg-10'>
                            <label className='form-label fw-medium'>Dekking</label>

                            <div className="form-check">
                                <input className="form-check-input" type="checkbox" defaultValue id="nationaalonbeperktbellen" />
                    ...
                    <div className='row'>
                        <div className='col-10'>
                            <label className='form-label fw-medium'>Reconstructiekosten</label>
                        </div>
                        <div className="infcalcubx col-2">
...
export default BusinessDamageStep2Left