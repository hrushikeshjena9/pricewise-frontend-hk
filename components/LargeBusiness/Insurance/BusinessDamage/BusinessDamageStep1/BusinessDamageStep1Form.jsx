...
import BusinessDamageFormPopup from "./BusinessDamageFormPopup";
import TooltipInitialise from "../../../../common/TooltipInitialise";
const BusinessDamageStep1Form = ({ setShowStepper, showStepper, setCount }) => {
  ...
  return (
    <div>
      ...
      <div
        className="modal busi-damage fade"
        id="lbcmassets"
        tabIndex={-1}
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="funeral-modal-bx">
                ...
                <div className="row radiobx justify-content-center mt-4">
                  <div className="col-lg-4 col-md-4 col-sm-6">
                    <input type="radio" name="test" id="drl1" />
                    <label htmlFor="drl1" className="tooltip-container">
                      <Image
                        width={200}
                        height={200}
                        alt="aa"
                        ...
                        className="img-fluid"
                      />
                      <span className="checkbox-label">Herstelkosten</span>
                      <a
                        href="javascript:void(0);"
                        data-bs-toggle="tooltip"
                        data-bs-html="true"
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6">
                    <input type="radio" name="test" id="drl2" />
                    <label htmlFor="drl2" className="tooltip-container">
                      <Image
                        width={200}
                        height={200}
                        alt="aa"
                ...
                <div className="row radiobx justify-content-center mt-4">
                  <div className="col-lg-4 col-md-4 col-sm-6">
                    <input type="radio" name="test2" id="ys1" />
                    <label htmlFor="ys1">
                      <Image
                        width={200}
                        height={200}
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6">
                    <input type="radio" name="test2" id="yes2" />
                    <label htmlFor="yes2">
                      <Image
                        width={200}
                        height={200}
...
export default BusinessDamageStep1Form;
