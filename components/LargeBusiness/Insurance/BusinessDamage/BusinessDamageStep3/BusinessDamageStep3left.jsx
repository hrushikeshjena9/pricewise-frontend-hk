...
const BusinessDamageStep3left = ({ setShow, show }) => {
                  ...
                  <div className="card mt-4">
                    ...
                    <div className="card-body">
                        <div className="row">
                            <div className="col-lg-6">
                                <label className="fw-medium">
                                    ...
                                    de naastgelegen gebouwen aan de volgende voorwaarden:* <i className="fas green-cyan fa-info-circle"></i>
                                </label>
                                <ul className="small">
                        ...
                        <p>
                            ...
                            Let op! Deze vragen gelden voor alle belanghebbende van een aandeel van 33.3% of meer binnen een BV 
                            of vereniging. Als de aandeelhouders zelf een rechtspersoon is gelden de vragen ook voor de statutaire 
                            directeur(en) of bestuurder(s) daarvan.
                          </span>
                        </p>
                        <div className="row">
                            <div className="col-lg-6">
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                ...
                                <p className='small fw-normal'>
                                  Zijn er in de afgelopen 5 jaar schaden veroorzaak of geleden door gebeurtenissen die gedekt zijn op
                          ...
                          <div className="row">
                              ...
                              <div className="col-lg-6">
                              <label className="fw-bold">Bedrijfsmiddelenverzekering</label>
                              </div>
                              <div className="col-lg-6">
                              ...
                              <div className="col-lg-6">
                              <textarea className="form-control" rows={8} placeholder="Oorzaak"></textarea>
                              </div>
                              </div>
                            ...
                            <div className="col-lg-6">
                                <div className="row">
                                    ...
                                    <div className="col-lg-12 mt-3">
                                        <textarea className="form-control" rows={8} placeholder="Reden"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="card-body">
                        <div className="mb-3 ">
                            <label className="form-label">Verfieer hier jouw bank gegevens en voorkom samen fraude.*
                                <a href="javascript:void(0);" className='text-success' data-bs-toggle="tooltip" data-bs-html="true" 
                                aria-label="Content Goes Here" data-bs-custom-class="custom-tooltip" data-bs-original-title="Content Goes Here">
                                <i className="fas  fa-info-circle" /></a>
                            </label>
...
export default BusinessDamageStep3left;
