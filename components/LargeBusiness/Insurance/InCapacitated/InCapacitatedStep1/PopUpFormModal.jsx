...
const PopUpFormModal = ({ setShowStepper, showStepper, setCount }) => {
    ...
    <>
      ...
      >
        <Image
          ...
          alt="location"
        />{" "}
        Meerdere Vestigingen toevoegen. <sup className="sup-fonticon"><i class="fas green-cyan fa-info-circle"></i></sup>
      </a>
      {/* Popup or Modal */}
                          ...
                          <div className="col-9">
                            ...
                            <div className="row">
                              <div className="col-lg-12 position-relative">
                                ...
                                <div className="infcalcubx infbx only-infoNextra-incapacitated">
                                  <a
                                    href="javascript:void(0);"
                                    data-bs-toggle="tooltip"
                                    data-bs-html="true"
                      ...
                      <div className="col-lg-6 eventbxright">
                          ...
                          <div className="col-9">
                            ...
                            <label htmlFor="customRange1" className="form-label">
                              <div className="cus-num">
                                <span id="rangeValue1">€6,500</span>
                                <span>€ 200.000</span>
                              </div>
                            </label>
                          </div>
                        ...
                        <div className="row mt-2">
                          ...
                          <div className="col-9">
                            ...
                            <label htmlFor="customRange1" className="form-label">
                              <div className="cus-num">
                                <span id="rangeValue1">€4.000</span>
                                <span>€ 180.000</span>
                              </div>
                            </label>
                          </div>
                        ...
                        <div className="row mt-2">
                          ...
                          <div className="col-9">
                            ...
                            <label htmlFor="customRange1" className="form-label">
                              <div className="cus-num">
                                <span id="rangeValue1">3 jaar</span>
                                <span> 5 jaar</span>
                              </div>
                            </label>
                          </div>
                        ...
                        <div className="row mt-2">
                          ...
                          <div className="col-9">
                            ...
                            <label htmlFor="customRange1" className="form-label">
                              <div className="cus-num">
                                <span id="rangeValue1">60 jaar</span>
                                <span>63 jaar</span>
                              </div>
                            </label>
                          </div>
