...
const DirectorsLiabilityStep3Left = () => {
    return (
                    ...
                    <div className="card-body">
                        <form>
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-3">
                                    <input type="tel" className="form-control" id="mobileNumber" name="mobileNumber" placeholder="Bijv. 1200AA" />
                                </div>
                                <label htmlFor="landlineNumber" className="col-sm-3 col-form-label">Nummer & toevoeging</label>
                                <div className="col-sm-3">
                                    <input type="tel" className="form-control" id="landlineNumber" name="landlineNumber" placeholder="Bijv. 1124" />
                                </div>
                            </div>
                            <div className="row mb-3">
                ...
                <div className="card mt-4">
                    ...
                    <div className="card-body">
                        <div className="row">
                            <div className="col-lg-8">
                                <label>
                                Is de organisatie, een van de bestuurders of toezichthouders op de hoogte van gerechtelijke stappen, 
                                fouten of omstandigheden die kunnen leiden tot een aanspraak onder een bestuurdersaansprakelijkheid verzekering?* <i className='fas fa-info-circle'></i>
                                </label>
                            </div>
                        ...
                        <div className="row mt-4">
                            <div className="col-lg-8">
                                <label>
                                Is de organisatie, een van de bestuurders of toezichthouders betrokken in een proces of verwachten zij op korte termijn daarin betrokken te raken?*
                                </label>
                            </div>
                            <div className="col-lg-4">
                                <div className="row">
                                ...
                                <textarea placeholder='Oorzaak' className='form-control mt-3' rows={5}></textarea>
                            </div>
                        </div>
                        <div className='row mt-4'>
                            <div className='col-lg-8'>
                             <label>Wanneer is de organisatie opgericht?*</label>
                            </div>
                            <div className='col-lg-4'>
                                <input type='date' className='form-control'/>
                                <p className='fw-bold mt-2 mb-0'>Jaarrekeningen*</p>
                                <p className='small text-danger'>Let op, dit geld alleen voor een volledige boekjaar.</p>
                ...
                <div className="col-lg-12">
                  <div className="add-ques-bx">
                    <div className="row">
                      ...
                      <div className='col-lg-6 col-md-6 col-sm-6'>
                        <label className=' fw-bold text-break'>
...
export default DirectorsLiabilityStep3Left