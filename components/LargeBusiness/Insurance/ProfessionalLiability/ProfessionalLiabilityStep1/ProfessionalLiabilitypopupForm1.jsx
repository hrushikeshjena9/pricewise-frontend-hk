...
const ProfessionalLiabilitypopupForm1 = () => {
                    ...
                    <div className="col-lg-6 eventbxright">
                      <div className="row">
                        <div className="col-9">
                          ...
                          <div className="row ">
                        <div className=" col-lg-12 px-4 radiobx">
                          <div className="row justify-content-lg-center">
                            <div className="col-lg-3  col-4  col-sm-4  p-0  col-md-3">
                              <input type="radio" name="test" id="cb21" />
                              <label htmlFor="cb21" className="tooltip-container">
                                <Image
                                  width={128}
...
export default ProfessionalLiabilitypopupForm1