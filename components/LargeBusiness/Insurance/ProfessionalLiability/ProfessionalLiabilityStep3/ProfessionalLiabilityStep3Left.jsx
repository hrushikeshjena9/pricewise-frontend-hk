...
const ProfessionalLiabilityStep3Left = () => {
    return (
                    ...
                    <div className="card-body">
                        <form>
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-3">
                                    <input type="email" className="form-control" id="email" name="email" placeholder="Βίν. 1200AA" />
                                </div>
                ...
                <div className="card mt-4">
                    ...
                    <div className="card-body">
                        ...
                        <div className="row">
                            ...
                            <div className='col-lg-6'>
                                <textarea className="form-control" placeholder='Oorzaak' rows={5}></textarea>
                            </div>
                        </div>
                        <div className="row mt-4">
                            ...
                            <div className="col-lg-6">
                                <div className="row">
                                    ...
                                    <textarea className="form-control" placeholder='Reden' rows={8}></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="card-body">
                        <div className="mb-3 ">
                            <label className="form-label">Verfieer hier jouw bank gegevens en voorkom samen fraude.*
                                <a href="javascript:void(0);" className='text-success' data-bs-toggle="tooltip" data-bs-html="true" aria-label="Content Goes Here" data-bs-custom-class="custom-tooltip" data-bs-original-title="Content Goes Here"><i className="fas fa-2x fa-info-circle" /></a>
                            </label>
...
export default ProfessionalLiabilityStep3Left