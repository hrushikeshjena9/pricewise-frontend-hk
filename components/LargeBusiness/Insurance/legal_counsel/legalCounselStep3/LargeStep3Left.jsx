        ...
        <div className="profile-details">
          <div className="card mt-4">
            <div className="card-header">
              <h4 className="mb-0">
                <Image src="/images/archives.png" height={50} width={50} alt="aa" />{" "}
                Bedrijfsgegevens
              </h4>
            </div>
              ...
              <form>
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <a href="#" className="add-text">
                      <i className="fal fa-plus"></i> <span>Filiaal toevoegen</span>
                    </a>
                  </div>
                </div>
              </form>
          ...
          <div className="card mt-4">
            ...
            <div className="card-body">
              <div className='row'>
                <div className='col-lg-8'>
                  <label>
                    Heb jij beroepsmatige nevenactiviteiten?*
              ...
              <div className='row mt-2'>
                <div className='col-lg-8'>
                  <label>
                    Zijn er voorvallen geweest of aanwijzingen die de behoefte aan rechtshulp vergroten of een beroep op rechtsbijstand waarschijnlijk maken?*
              ...
              <div className='row mt-2'>
                <div className='col-lg-8'>
                  <label>
                    Ben jij de afgelopen 3 jaar verwikkeld geweest of nog verwikkeld in juridische geschillen of rechtzaken?*
                  </label>
                </div>
                <div className="col-lg-4">
                  <div className="row">
