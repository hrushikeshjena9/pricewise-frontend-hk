                                        ...
                                        <div className='col-9'>
                                                ...
                                                <div className="col-12">
                                                    <div className="row">
                                                        <div className="col-12 position-relative">
                                                            ...
                                                            <div className="infcalcubx only-infoNextra-corporateliability">
                                                                <ul className="list-unstyled">
                                                                    <li>
                                                                        <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-html="true" title="Content Goes Here">
                                                                            <i className="fas fa-2x fa-info-circle" />
                                                                    ...
                                                                    <li>
                                                                        <a href="javascript:void(0);" className="extra-healthinsurance ">
                                            ...
                                            <div className="row">
                                                <div className="col-12 position-relative">
                                                    ...
                                                    <div className="infcalcubx toevoe-position">
                                                        <ul className="list-unstyled">
                                                            <li>
                                                                <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-html="true" title="Content Goes Here">
                                                                    <i className="fas fa-2x fa-info-circle" />
                                                            ...
                                                            <li>
                                                                <div className="text-center only-toe-glassinsurance-large ">
                                            ...
                                            <div className='text-center'>
                                                <a href="#addresschange" className='text-dark btn-link' data-bs-toggle="modal">
                                                    <Image src='/images/add-location-point.png' width={24} height={24} alt='location' />
                                                    Meerdere Vestigingen toevoegen. <sup class="sup-fonticon"><i class="fas green-cyan fa-info-circle"></i></sup>
                                                </a>
                                            </div>
                                            {/* The modal */}
                                            ...
                                            <div className='col-9'>
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-12 position-relative">
                                                        ...
                                                        <div className="infcalcubx overzicht-info-position">
                                                            <ul className="list-unstyled">
                                                                <li>
                                                                    <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-html="true" title="Content Goes Here">
                                                                        <i className="fas fa-2x fa-info-circle" />
...
export default GlassInsuranceFormpopup