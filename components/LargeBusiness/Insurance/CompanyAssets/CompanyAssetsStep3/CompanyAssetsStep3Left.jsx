...
const CompanyAssetsStep3Left = ({ setShow, show }) => {
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                ...
                                <ul className="list-unstyled list-style-cr">
                                    ...
                                    <li className='fw-medium'>Weigering bij een aanvraag of opzegging van de Verzekeraar
                                    </li>
...
export default CompanyAssetsStep3Left;
