                                    ...
                                    <div className="table-responsive table-scroll">
                                        ...
                                        <table className="table table-striped table-bordered">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th><span>Looptijd:</span></th>
                                                    <td><span>....Maanden</span></td>
                                                </tr>
                                                <tr>
                                                    <th>Bespaar p.j.:</th>
                                                    <td>€...</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select className='form-select'>
                                                <option> Your Data Show Here.</option>
                                                <option> Your Data Show Here.</option>
                                                <option> Your Data Show Here.</option>
                                            </select>
                                        </td>
                                ...
                                <div className="modal-body">
                                    ...
                                    <table className='table table-brodered'>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Bedrijfsaansprakelijkheid </td>
                                                    <td><Image src='/images/faqicon.png' width={24} height={24} alt='aa'/></td>
                                                    <td>....</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>Bedrijfsschade</td>
                                                    <td><Image src='/images/faqicon.png' width={24} height={24} alt='aa'/></td>
                                                    <td>....</td>
                                                </tr>
                                                <tr>
                                                    <td>Inbraak, vandalisme &Diefstal</td>
                                                    <td>....</td>
                                                    <td>....</td>
                                                </tr> 
                                            </tbody>
...
export default CompanyAssetsTabing