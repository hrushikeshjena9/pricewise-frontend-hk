...
const BuildingInsuranceStep4Right = () => {
      ...
      <div className="stepright3">
        <div className="card mt-4">
          <div className="card-body p-0 shadow">
            ...
            <p className="px-4">
              <b>Tip:</b> Wist jij dat als jouw bedrijf een Energise account
              heeft. Jij inzicht krijgt in al jouw producten & diensten die jij
              bij ons afneemt.
            </p>
          </div>
        </div>
...
export default BuildingInsuranceStep4Right;
