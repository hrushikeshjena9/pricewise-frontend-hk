...
const BuildingInsuranceStep3left = () => {
  return (
        ...
        <div className="card mt-4">
          ...
          <div className="card-body">
            <div className="row">
              <div className="col-lg-6">
                ...
                <ul className="small list-style-cr">
                  ...
                  <li>
                    {" "}
                    Het gebouw heeft een harde dakbedekking met
                    dakbeschot (geen riet)
                  </li>
            ...
            <div className="row mt-3">
              <div className="col-lg-6">
                <label>
                  Wordt het gebouw uitsluitend gebruikt voor eigen
                  activiteiten?*
                </label>
              </div>
              <div className="col-lg-6">
            ...
            <div className="row mt-3">
              <div className="col-lg-6">
                <label>
                  Is hiervoor een door het CCV erkend Borg-bedrijf
                  opleveringsbewijs afgegeven?*
                </label>
              </div>
              <div className="col-lg-6">
                <div className="row">
            ...
            <h4 className="mt-4 text-center">Verzekeringsverleden</h4>
            <p>
            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                <label className="fw-bold">Bedrijfsschadeverzekering</label>
              </div>
              <div className="col-lg-6">
              ...
              <div className="col-lg-6">
                <textarea  rows={5} className="form-control" placeholder="Oorzaak"></textarea>
              </div>
            </div>
            <div className="row mt-3">
              <div className="col-lg-6">
...
export default BuildingInsuranceStep3left;
