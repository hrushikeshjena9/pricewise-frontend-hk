...
const CommercialVehiclesStep4Right = () => {
  return (
    <>
        ...
        <div className="stepright3">
          <div className="card mt-4">
            <div className="card-body p-0 shadow">
              ...
              <p className="px-4">
                <b>Tip:</b> Wist jij dat als jouw bedrijf een Energise <a href='#' className='btn-link text-dark'>account</a> heeft. Jij inzicht krijgt in al jouw producten 
                &amp; diensten die jij bij ons afneemt.
              </p>
            </div>
          </div>
          <div className="card mt-4">
...
export default CommercialVehiclesStep4Right