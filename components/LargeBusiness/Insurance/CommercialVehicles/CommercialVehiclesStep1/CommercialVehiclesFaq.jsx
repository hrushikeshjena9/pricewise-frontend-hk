...
const CommercialVehiclesFaq = () => {  <h2>Alles over <span>Bedrijsautoverzekering</span> Deals</h2>
  return (
    <section>
    <div className="faq-wrp dealquestion">
                    <div className="page-title">
                        <h2>Alles over <span>Bedrijsautoverzekering</span> Deals</h2>
                    </div>
...
export default CommercialVehiclesFaq
