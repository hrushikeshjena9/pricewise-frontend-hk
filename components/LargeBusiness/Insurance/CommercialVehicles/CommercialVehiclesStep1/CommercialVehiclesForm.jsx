...
import CommercialVehiclpopup from "./CommercialVehiclpopup";
import SameHeightDiv from "../../../../common/SameHeightDiv";
const CommercialVehiclesForm = ({ setCount }) => {
                ...
                <div className="col-lg-6 eventbxleft">
                  ...
                  <div className="text-center">
                    ...
                    {!showExtendedContent && (
                      <a
                        href="javascript:void(0);"
                        className="text-warning fw-bold d-block mt-2"
...
export default CommercialVehiclesForm;
