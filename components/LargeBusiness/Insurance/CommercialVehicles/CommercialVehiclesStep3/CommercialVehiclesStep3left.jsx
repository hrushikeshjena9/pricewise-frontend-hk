...
const CommercialVehiclesStep3left = () => {
        ...
        <div className="profile-details">
          <div className='card'>
            <div className='card-header'>
              <h4 className="mb-0">
                <Image src='/images/archives.png' height={40} width={30} alt='aa' /> Bedrijfsgegevens
              </h4>
            </div>
          ...
          <div className="card mt-4">
            ...
            <div className="card-body pt-0">
              ...
              <div className='row'>
                ...
                <div className="col-lg-6">
                  <label className="fw-bold">Bedrijfsautoverzekering</label>
                </div>
              </div>
              <div className='row'>
                <div className="col-lg-6">
...
export default CommercialVehiclesStep3left;