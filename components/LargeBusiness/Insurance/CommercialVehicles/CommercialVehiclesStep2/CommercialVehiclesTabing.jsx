...
const CommercialVehiclesTabing = () => {
  return (
    <>
                  ...
                  <div className="tabbxleft">
                    <div className="table-responsive table-scroll">
                      <table className="table table-striped table-bordered">
                        <h4>Wettelijke aansprakelijkheid (WA)</h4>
                        <tbody>
                          <tr>
                            <th scope="row">
                              Premie kosten: <i className="fas fa-info"></i>
                            </th>
                            <td>€...</td>
                          </tr>
                          <tr>
                            <th scope="row">
                              Aanvulling: <i className="fas fa-info"></i>
                            </th>
                            <td>€...</td>
                          </tr>
                          <tr>
                            <th scope="row">
                              Eenmalige kosten: <i className="fas fa-info"></i>
                            </th>
                            <td>€...</td>
                          </tr>
                          <tr>
                            <th scope="row">Eigen risico:</th>
                            <td>€...</td>
                          </tr>
                          <tr>
                            <td>
                              <span className="fw-bold">Totaal:</span>
                            </td>
                            <td>
                              <span className="fw-bold">€... p.m.</span>
                            </td>
                          </tr>
                          <tr>
                            <td>
                      ...
                      <p className="small">
                        Prijzen zijn inc. 21% Assurantie belasting
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <tr>
                      <th colSpan={3} className="text-center">
                        <Image
                          ...
                          height={103}
                          className="img-fluid"
                          src="/images/taskc.png"
                          alt="aabb"
                        />{" "}
                        <h3> Checklist ALL RISK</h3>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
...
export default CommercialVehiclesTabing;
