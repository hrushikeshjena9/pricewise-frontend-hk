                ...
                <div className="card mt-4">
                    ...
                    <div className="card-body">
                        ...
                        <div className="row my-4">
                            <div className="col-lg-6">
                                <label>
                                Heb je beveiligingssoftware of apps op je apparaten geïnstalleerd?
                        ...
                        <div className='row'>
                            ...
                            <div className="col-lg-6">
                            <label className="fw-bold">Cybersecurity</label>
                            </div>
                        </div>
                        <div className='row'>
                            <div className="col-lg-6">
                    ...
                    <div className="card-body">
                        <div className="mb-3 ">
                            <label className="form-label">Verfieer hier jouw bank gegevens en voorkom samen fraude.*
                                <a href="javascript:void(0);" className='text-success' data-bs-toggle="tooltip" 
                                data-bs-html="true" aria-label="Content Goes Here" data-bs-custom-class="custom-tooltip" 
...
export default CyberSecurityStep3Left