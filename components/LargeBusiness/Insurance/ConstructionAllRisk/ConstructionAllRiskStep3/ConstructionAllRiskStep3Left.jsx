...
const ConstructionAllRiskStep3Left = () => {
  return (
    <div className="col-lg-8">
      <div className="profile-details">
        ...
        <div className="card mt-4">
          ...
          <div className="card-body">
            ...
            <a href="javascript:void(0);" className="text-success">
              <i className="fas fa-map-marker-alt"></i> Meerdere Vestigingen
              toevoegen.
            </a>
          </div>
        </div>
        <div className="card mt-4">
          ...
          <div className="card-body">
            <div className="row">
              <div className="col-lg-8">
                <label>
                  Welke deel van jouw omzet wordt gerealiseert door
                  onderaannemers?*
            ...
            <div className="row">
              <div className="col-lg-8">
                <label>
                  Is het gebouw beveiligd door een alarminstallatie en/of
                  voorzien van camaratoezicht?
                </label>
              </div>
              <div className="col-lg-4">
                <div className="row">
            ...
            <div className="row mt-4">
              <div className="col-lg-8">
                <label>
                  Wordt jouw werkzaamheden voornamelijk uitgevoerd op een of
                  meer van de volgende tereinen?
                </label>
                <p className="small fw-normal">
                  Betonrenovatie, betonbouw, keiderbouw. (paal)funderingswerk,
                  grondkerende constructies (zoals damwanden), (bron) bemaling.
                  ondergrondse kabels, Vioerafwerking, sloopprojecten,
          ...
          <div className="card-body">
            ...
            <p>
              <span className="text-danger">
                Let op! Deze vragen gelden voor alle belanghebbende van een
                aandeel van 33.3% of meer binnen een BV of vereniging. Als de
                aandeelhouders zelf een rechtspersoon is gelden de vragen ook
                voor de statutaire directeur(en) of bestuurder(s) daarvan.
              </span>
            </p>
            <div className="row">
              <div className="col-lg-6">
            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                <label className="fw-bold">Construction All Risk</label>
              </div>
            </div>
            <div className="row">
              <div className="col-lg-6">
            ...
            <div className="row mb-3">
              <div className="col-lg-6">
                ...
                <p className="fw-normal text-grey small">
                  ...
                  verzekeringsmaatschappij enige vorm van verzekering geweigerd
                  of opgezegd, of zijn er beperkende voorwaarden of verhoogde
                  premies aangekondigd, dan wel verplicht gesteld die specifiek
                  en uitsluitend voor dat risico en voor de verzekering golden?
                </p>
              </div>
              <div className="col-lg-6">
                <div className="row">
            ...
            <div className="row mb-3">
              <div className="col-lg-6">
                ...
                <p className="fw-normal text-grey small">
                  ...
                  van meer dan 20 uur), of aanraking met justitie ter uitvoering
                  van een opgelegde (straf)maatregel in verband met
        ...
        <div className="card mt-4">
          <div className="card-header">
            <h4 className="mb-0">
              <i className="fas fa-credit-card" /> Verificatie
            </h4>
          </div>
          <div className="card-body">
            <div className="mb-3 ">
...
export default ConstructionAllRiskStep3Left;
