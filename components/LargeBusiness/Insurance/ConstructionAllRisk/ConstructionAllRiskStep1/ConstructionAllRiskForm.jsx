...
import ConstructionAllRiskFrontAdressPopup from "./ConstructionAllRiskFrontAdressPopup";
...
const ConstructionAllRiskForm = ({ setShowStepper, showStepper, setCount }) => {
                      ...
                      <div className="col-9">
                        ...
                        <div className="row">
                          <div className="col-lg-12 position-relative">
                            ...
                            <div className="frm-toevoe-position text-center new-class">
                              <input
                                className="form-check-input mb-0 new-class"
                                type="checkbox"
                                id="flexCheckDefault"
                              ...
                              <div className="form-check-label d-block fw-bold new-class">
                                <label
                                  ...
                                  className="form-check-label d-block fw-bold green-cyan new-class"
                                >
                                  Toevoegen
                                </label>
                              </div>
                        ...
                        <div className="text-center mt-3">
                          ...
                          >
                            ...
                            <sup className="sup-fonticon">
                              <i className="fas green-cyan fa-info-circle" />
                            </sup>
                          </a>
                        </div>
                      </div>
                      <ConstructionAllRiskFrontAdressPopup />
                    </div>
...
export default ConstructionAllRiskForm;
