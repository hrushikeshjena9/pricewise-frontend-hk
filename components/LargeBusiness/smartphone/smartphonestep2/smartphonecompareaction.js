...
const SmartPhoneCompareAction = ({setShowMoreInfo, showMoreInfo}) => {
  return (
    <>
        ...
        {showMoreInfo && (
          <div id="listhiddenDiv1" className="tabwrp">
            ...
            <div className="tab-content" id="myTabsContent">
              <div
                className="resizer-font tab-pane fade show active"
                id="tab1"
                role="tabpanel"
...
export default SmartPhoneCompareAction;
