...
const InternetTvTelephoneLeftStep4 = () => {
    return (
        <>
            <div className="col-lg-8">
                <div className="lsttitle">
                    ...
                    <div className="secure-wrp">
                        <Image src="/images/secure.png" height={100} width={100} alt='aa'  className="img-fluid secureimg" />
                    </div>
                    <h4>
...
export default InternetTvTelephoneLeftStep4