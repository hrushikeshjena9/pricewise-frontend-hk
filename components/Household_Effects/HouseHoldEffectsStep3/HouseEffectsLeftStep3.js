                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="ad-ques-text">
                      <p>Ga jij zelf in de woning wonen per dd-mm-jjjj?</p>
                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="ad-ques-text">
                      <p>
                        ...
                        gevestigd zoals een restaurant, snackbar of
                        benzinepomp?*
                      </p>
                      <i className="fa fa-info-circle" />
                    </div>
                  ...
                  <div className="col-lg-6">
                    ...
                    >
                      <div className="col-sm-12">
                        <p>
                          Wat is de afstand van dit bedrijf naar jouw woning?
                        </p>
            ...
            <div className="insurance-sec">
              ...
              <div className="col-lg-12">
                <div className="add-ques-bx">
                  ...
                  <div className="row">
                    <div className="col-6">
                      <p>Schadebedrag per gebeurtenis*</p>
                    </div>
                    <div className="col-6">
                      ...
                      <div className="col-lg-6">
                        <div className="ad-ques-text">
                          ...
                          <span>
                            ...
                            voorwaarden of verhoogde premies aangekondigd, dan
                            wel verplicht gesteld die specifiek en uitsluitend
                            voor dat risico en voor de verzekering golden?
                          </span>
                        </div>
                      </div>
                      <div className="col-lg-6">
                      ...
                      <div className="col-lg-6">
                        <div className="ad-ques-text">
                          ...
                          <span>
                            ...
                            een uitgebrachte dagvaaring in een lopende
...
export default HouseEffectsLeftStep3;
