...
const HouseEffectsCompareTabbingPartStep2 = () => {
  return (
    <>
                  ...
                  <div className="tabbxleft">
                    <div className="table-responsive table-scroll">
                      ...
                      <table className="table table-striped table-bordered">
                        <tbody>
                          <tr>
                            <th scope="row">Inboedel</th>
                            <td>€...</td>
                          </tr>
                          <tr>
                            <th scope="row">Overige Kosten  <a
                          ...
                          <tr>
                            <th scope="row">Eenmalige kosten  <a
                                href="javascript:void(0);"
                                data-bs-toggle="tooltip"
                                data-bs-html="true"
                                aria-label="Content Goes Here"
...
export default HouseEffectsCompareTabbingPartStep2
