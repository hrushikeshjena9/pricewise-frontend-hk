...
import LiabilityCompareTabbingPartStep2 from './HouseEffectsCompareTabbingPartStep2'

const HouseEffectsCompareActionStep2 = () => {
  ...
  return (
    ...
    <div className="listofcompanybx">
      ...
      {showMoreInfo && (
        <LiabilityCompareTabbingPartStep2 />
      )}
    </div>
  </>
  )
...
export default HouseEffectsCompareActionStep2
