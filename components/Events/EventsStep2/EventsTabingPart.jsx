...
import EventsTab2Slider from './EventsTab2Slider'

const EventsTabingPart = () => {
    return (
        <>
                            ...
                            <div className="row">
                                        ...
                                        <div className="table-responsive table-scroll">
                                            ...
                                            <table className="table table-striped table-bordered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th colSpan={2} scope="row">Kosten:</th>
                                                    </tr>
                                                    <tr>
                                                        <td>Zaal kosten:</td>
                                                        <td>€....</td>
                                                    ...
                                                    <tr>
                                                        <td>Catering kosten:</td>
                                                        <td>€....</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Versiering/stylisten:</td>
                                                        <td>€....</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Muziek/Foto-videograaf</td>
                                                        <td>€....</td>
                                                    </tr>
                                                    <tr>
                                ...
                                <div className="col-lg-6">
                                    ...
                                    <div className="text-center">
                                        <a href="javascript:void(0);" className="viwmr" data-bs-toggle="modal" data-bs-target="#faqModal">Meer vragen?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
                            <div className="row">
                                ...
                                <div className="col-lg-6">
                                    ...
                                    <div className="text-center">
                                        <a href="#" className="fw-600" data-bs-toggle="modal" data-bs-target="#faqModal">
                                            Meer vragen?
                                        </a>
                                    </div>
                                </div>
            ...
            <div className="modal quantityModal fade" id="faqModal" tabIndex={-1} aria-labelledby="faqModalLabel" aria-hidden="true">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className='quantitybxtitle'>
                                <ul>
                                    <li><h2>Veel gestelde vragen</h2></li>
                                    <li><img src="/images/suggestion.png" alt="" /></li>
                                </ul>
                            </div>
                            <div className="filter-event-bx">
...
export default EventsTabingPart